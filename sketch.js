...
function mousePressed() {
  ...
  let danceLink = document.getElementById("hiddenDanceLink");
  if (danceLink) {
    danceLink.click(); // ✅ mobile-safe trigger
  } else {
...
function setup() {
  ...
  setupDanceButtonFix(); // 🟢 add this line
}
